<div class="container mb-4">   
        <div class="row d-flex flex-row flex-wrap-reverse gx-5 ">
            <div class="col-sm-6">
                ...
                <p class="text-md-end text-sm-center text-center object-fit-content">All profits go to the Big Life Foundation</p>
            ...
            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/akwanza-t-shirt.png" class="img-fluid text-center" alt="T-shirt Image">  
            </div>
        </div>
</div>